...
type LocalExecutionParameters struct {
	...
	TimeLimitHardMicros   uint64              `protobuf:"varint,15,opt,name=time_limit_hard_micros,json=timeLimitHardMicros,proto3" json:"time_limit_hard_micros,omitempty"`
...
type IdentifyRequest struct {
	...
	MongoHost   string `protobuf:"bytes,2,opt,name=mongo_host,json=mongoHost,proto3" json:"mongo_host,omitempty"`
	MongoDb     string `protobuf:"bytes,3,opt,name=mongo_db,json=mongoDb,proto3" json:"mongo_db,omitempty"`
}
...
func (this *LocalExecutionParameters) Equal(that interface{}) bool {
	...
	if this.TimeLimitHardMicros != that1.TimeLimitHardMicros {
		return false
	}
...
func (this *IdentifyRequest) Equal(that interface{}) bool {
	...
	if this.MongoHost != that1.MongoHost {
		return false
	}
	if this.MongoDb != that1.MongoDb {
		return false
	}
	return true
}
...
func (this *LocalExecutionParameters) String() string {
	...
	s := strings.Join([]string{`&LocalExecutionParameters{`,
		...
		`TimeLimitHardMicros:` + fmt.Sprintf("%v", this.TimeLimitHardMicros) + `,`,
...
func (this *IdentifyRequest) String() string {
	...
	s := strings.Join([]string{`&IdentifyRequest{`,
		...
		`MongoHost:` + fmt.Sprintf("%v", this.MongoHost) + `,`,
		`MongoDb:` + fmt.Sprintf("%v", this.MongoDb) + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 15:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TimeLimitHardMicros |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *IdentifyRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.MongoHost = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.MongoDb = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipLocal(dAtA[iNdEx:])
...
var fileDescriptorLocal = []byte{
	...
	,
}
